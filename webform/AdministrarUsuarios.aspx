        ...
        <div class="tab-content mt-3" id="myTabContent">
            ...
            <div class="tab-pane fade" id="estadisticas" role="tabpanel" aria-labelledby="estadisticas-tab">
                ...
                <div style="display: flex; justify-content: space-around; flex-wrap: wrap; align-items: center;">
                    <!-- USUARIOS -->
                    <div class="card text-bg-secondary mb-3" style="width: 26%;">
                        <div class="card-header" style="text-align: center;">Usuarios</div>
                        <div class="card-body">
                            <h1 class="card-title" style="text-align: center;">
                                <asp:Label ID="lblUsuarios" Text="null" runat="server" />
                            </h1>
                    ...
                    <!-- CURSOS -->
                    <div class="card text-bg-secondary mb-3" style="width: 26%;">
                        <div class="card-header" style="text-align: center;">Cursos</div>
                        <div class="card-body">
                            <h1 class="card-title" style="text-align: center;">
                                <asp:Label ID="lblCursos" Text="null" runat="server" />
                            </h1>
                        </div>
                    </div>
                    <!-- PORCENTAJE CURSOS x USUARIOS -->
                    <div class="card text-bg-secondary mb-3" style="width: 26%;">
                        <div class="card-header" style="text-align: center;">Porcentaje</div>
                        <div class="card-body">
                            <h1 class="card-title" style="text-align: center;">
                    ...
                    <!-- INSCRIPCIONES -->
                    <div class="card text-bg-secondary mb-3" style="width: 26%;">
                        <div class="card-header" style="text-align: center;">Inscripciones</div>
                        <div class="card-body">
                            <h1 class="card-title" style="text-align: center;">
