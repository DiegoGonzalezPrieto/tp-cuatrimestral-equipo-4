    ...
    <h1 class="text-center" > - Bienvenido a nuestra web de cursos - </h1>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><asp:Button ID="BtnCat1" runat="server" CssClass="dropdown-item" Text="Categoria extra 1" OnClick="BtnCat1_Click" /></li>
                <li><asp:Button ID="BtnCat2" runat="server" CssClass="dropdown-item" Text="Categoria extra 2" OnClick="BtnCat2_Click" /></li>
                <li><asp:Button ID="BtnCat3" runat="server" CssClass="dropdown-item" Text="Categoria extra 3" OnClick="BtnCat3_Click" /></li>
            </ul>
        </div>
    </div>
